// SMARTLABS · ESP32 lector de acceso de BECARIOS al espacio (SMART10000)
// =========================================================================
// Recibe el UID por UART (Arduino+RC522 con arduino_lector_universal.ino),
// lo publica a {SN}/scholar_query y reacciona a los comandos del backend
// (granted1 = ingreso registrado, granted0 = salida registrada, refused).
//
// Mejoras respecto a la versión legacy (main_becarios.cpp): char[], queue,
// WiFi/MQTT robustos, LWT, sin temprature_sens_read.
...
// CONFIGURACIÓN
// -------------------------------------------------------------------------
static const char*  DEVICE_SN   = "SMART10000";
static const char*  TOPIC_QUERY = "scholar_query";
static const IPAddress LOCAL_IP(192, 168, 0, 185);
